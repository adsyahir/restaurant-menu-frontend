<template>
  <div class="space-y-6">
    <div class="space-y-1 text-center">
      <h1 class="text-3xl font-bold tracking-tight">Our Menu</h1>
      <p class="text-muted-foreground">Authentic Malaysian favourites, freshly made to order.</p>
    </div>
...
import { categories, menuItems, dietaryTagLabels } from '@/data/menu'
